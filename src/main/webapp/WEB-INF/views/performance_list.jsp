    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h3 class="content-heading">Performance List</h3>
                </div>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <button type="button" class="btn btn-primary float-right" id="exportBtn"
                                        style="float: right;margin-bottom:20px">Export Data
                                </button>
                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <c:forEach var="abc" items="${performanceList}">
                                        <tr>


                                            <td>${abc.internId}</td>
                                            <td>${abc.task}</td>
                                            <td>${abc.completionStatus}</td>
                                            <td>${abc.perfomanceScore}</td>
                                            <td><a href="/InternManagement/performance/edit/${abc.id}">Edit</a>
                                            </td>
                                            <td>
                                                <a href="/InternManagement/performance/delete/${abc.id}">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
