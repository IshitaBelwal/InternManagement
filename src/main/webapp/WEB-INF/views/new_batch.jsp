                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="/InternManagement/batch/add" method="POST">
                                            <div class="form-row">
                                                <div class="col-4">
                                            ...
                                            <div class="form-row" style="margin-top: 20px;">
                                                <div class="col-6">
                                                    ...
                                                    <input type="date" class="form-control" name="startDate" placeholder="Intern DOB">
                                                </div>
                                                <div class="col-6">
                                                    <label>End Date</label>
                                                    <input type="date" class="form-control" name="endDate" placeholder="Intern DOB">
