    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h3 class="content-heading">Batch List</h3>
                </div>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <c:forEach var="batch" items="${allBatch}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/InternManagement/intern/getInternByBatchName/${batch.code}">${batch.code}</a>
                                            </td>
                                            ...
                                            <td>${batch.endDate}</td>
                                            <td><a href="/InternManagement/batch/edit/${batch.id}">Edit</a></td>
                                            <td><a href="/InternManagement/batch/delete/${batch.id}">Delete</a></td>
                                        </tr>
                                    </c:forEach>
