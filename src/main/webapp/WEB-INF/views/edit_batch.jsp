            ...
            <div
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id='insertdiv'>
                        <div class="col-12">
                            <h3 class="content-heading mt-3">Edit Batch</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="/InternManagement/batch/update" method="POST">
                                            <div class="form-row">
                                                <div class="col-4">
                                                    <label>Batch Code</label>
                                                    <input type="text" class="form-control" name="code" placeholder="Batch Code" value="${batch.code}">
                                                </div>
                                                <div class="col-4">
                                                    <label>Category</label>
                                                    <input type="text" class="form-control" name="category" placeholder="Category" value="${batch.category}">
                                                </div>
                                                <div class="col-4">
                                                    <label>Trainer Name</label>
                                                    <input type="text" class="form-control" name="name" placeholder="Trainer Name"value="${batch.name}">
                                                </div> 


                                            </div>
                                                <input type="text" class="form-control" name="id" hidden placeholder="id" value="${batch.id}">

                                            <div class="form-row" style="margin-top: 20px;">
                                                <div class="col-6">
                                                    <label>Start Date</label>
                                                    <input type="date" class="form-control" name="startDate" placeholder="Intern DOB" value="${batch.startDate}">
                                                </div>
                                                <div class="col-6">
                                                    <label>End Date</label>
                                                    <input type="date" class="form-control" name="endDate" placeholder="Intern DOB"value="${batch.endDate}">
