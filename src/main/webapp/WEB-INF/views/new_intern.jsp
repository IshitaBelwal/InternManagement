    ...
    <div
        ...
        <div class="container-fluid">
            ...
            <div class="row" id='insertdiv'>
                <div class="col-12">
                    <h3 class="content-heading mt-3">New Intern</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/InternManagement/intern/add" method="POST">
                                    <div class="form-row">
                                        <div class="col-6">
                                    ...
                                    <div class="form-row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="course"
                                                   placeholder="Intern Course">
                                        </div>

                                        <div class="col-6">
                                            <label>Intern DOB</label>
                                            <input type="date" class="form-control" name="dob" placeholder="Intern DOB">
                                        </div>
                                    ...
                                    <div class="form-row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select class="form-control" name="batchid" id="batchid">
                                                <c:forEach items="${allBatch}" var="batch">
                                    ...
                                    <div class="form-row" style="margin-top: 20px;">
                                        <div class="col-6">
                                            ...
                                            <textarea type="text" class="form-control" name="address"
                                                      placeholder="Intern Adderss"></textarea>
                                        </div>

                                        <div class="col-6">
                                            <label>Intern Description</label>
                                            <textarea type="text" class="form-control" name="description"
                                                      placeholder="Intern Description"></textarea>
                                    ...
                                    <button class="btn btn-primary" type="submit" style="margin-top:20px;float:right">
                                        Save
                                    </button>
