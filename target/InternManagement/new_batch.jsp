    ...
    <div
        ...
        <div class="container-fluid">
            ...
            <div class="row" id='insertdiv'>
                <div class="col-12">
                    <h3 class="content-heading mt-3">New Batch</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/dashboard/store-listing/category/insert" method="POST">
                                    <div class="form-row">
                                        <div class="col-4">
                                            <label>Batch Code</label>
                                            <input type="text" class="form-control" name="code" placeholder="Batch Code">
                                        </div>
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Trainer Name">
                                        </div>
                                    ...
                                    <div class="form-row" style="margin-top: 20px;">
                                        <div class="col-6">
                                            ...
                                            <input type="date" class="form-control" name="start_date" placeholder="Intern DOB">
                                        </div>
                                        <div class="col-6">
                                            <label>End Date</label>
                                            <input type="date" class="form-control" name="end_date" placeholder="Intern DOB">
