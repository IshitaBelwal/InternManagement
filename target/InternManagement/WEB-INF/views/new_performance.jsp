    ...
    <div
        ...
        <div class="container-fluid">
            ...
            <div class="row" id='insertdiv'>
                <div class="col-12">
                    <h3 class="content-heading mt-3">New Performance</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/InternManagement/performance/add" method="POST">
                                    <div class="form-row">
                                        <div class="col-4">
                                            <label>Intern Name</label>

                                            <select class="form-control" name="InternId">
                                        ...
                                        <div class="col-4">
                                            <label>Batch</label>
                                            <select class="form-control" name="internshipBatchid">
                                    ...
                                    <div class="form-row" style="margin-top: 20px;">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="completionStatus"
                                                   placeholder="Completion Status">
                                        </div>
                                        <div class="col-6">
                                            <label>Performance Score</label>
                                            <input type="text" class="form-control" name="perfomanceScore"
