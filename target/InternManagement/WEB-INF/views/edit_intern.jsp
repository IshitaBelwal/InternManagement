            ...
            <div
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id='insertdiv'>
                        <div class="col-12">
                            <h3 class="content-heading mt-3">Edit Intern</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="/InternManagement/intern/update" method="POST">
                                            <div class="form-row">
                                                <div class="col-6">
                                                    <label>Intern Name</label>
                                                    <input type="text" class="form-control" name="name" placeholder="Intern Name" value="${intern.name}">
                                                </div>
                                                <div class="col-6">
                                                    <label>Intern College</label>
                                                    <input type="text" class="form-control" name="code" placeholder="Intern College" value="${intern.code}">
                                                </div>
                                            ...
                                            <div class="form-row" style="margin-top: 20px;">
                                                ...
                                                <div class="col-6">
                                                    <label>Intern Course</label>
                                                    <input type="text" class="form-control" name="course" placeholder="Intern Course" value="${intern.course}">
                                                </div>

                                                <div class="col-6">
                                                    <label>Intern DOB</label>
                                                    <input type="date" class="form-control" name="dob" placeholder="Intern DOB" value="${intern.dob}" >
                                                </div>
                                            ...
                                            <div class="form-row" style="margin-top: 20px;">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" name="number" placeholder="Intern Number" value="${intern.number}">
                                                </div>


                                                <input type="text" class="form-control" name="id" hidden placeholder="id" value="${intern.id}">
                                               
                                                <div class="col-4">
                                                    <label>Intern Batch</label>
                                            ...
                                            <div class="form-row" style="margin-top: 20px;">
                                                <div class="col-6">
                                                    <label>Intern Adderss</label>
                                                    <textarea type="text" class="form-control" name="address" placeholder="Intern Adderss" >${intern.address}</textarea>
                                                </div>

                                                <div class="col-6">
                                                    <label>Intern Description</label>
                                                    <textarea type="text" class="form-control" name="description" placeholder="Intern Description" >${intern.description}</textarea>
